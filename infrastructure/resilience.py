"""
TORQ Infrastructure - Resilience & Failure Recovery Module
...
Target Stack: Railway (FastAPI Backend)
"""
...
logger = logging.getLogger("torq.resilience")
...
class ResilientSupabase:
    ...
    def __init__(
        ...
        self._client = AsyncClient(supabase_url, supabase_key)
        self._sync_client = Client(supabase_url, supabase_key)
    ...
    def sync_table(self, table_name: str) -> Any:
        """Get synchronous table reference"""
        return self._sync_client.table(table_name)
...
class ResilientVectorSearch:
    ...
    async def search(
        ...
        try:
            ...
            return await self._text_search(str(query_embedding), filter_dict, top_k)
